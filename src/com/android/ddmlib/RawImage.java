...
public final class RawImage {
    ...
    public boolean readHeader(int version, ByteBuffer buf, int percentSize) {
        this.version = version;
        float Multiplier = percentSize/100;
        //int bufGetInt = buf.getInt();
        //System.out.print("Buffer getInt:" + Integer.valueOf(bufGetInt)  + "\n");
        ...
        if (version == 16) {
            ...
            this.height = buf.getInt(); //* percentSize/100;
            if (percentSize < 100) { 
            	//System.out.print("Buffer getInt:" + Integer.valueOf(buf.getInt())  + "\n");
                /*this.red_offset = 11;
                this.red_length = 5;
                this.green_offset = 5;
                this.green_length = 6;
    ...
    public void setImageSize(int percentImage) { 
        // read actual values.
        this.size = size * percentImage/100;
        this.width = width * percentImage/100;
        this.height = height * percentImage/100;
